...
def seed_users():
    ...
    stevie = User(
        full_name='Stevie Nix', username='nixie', email='nixie@aa.io', password='password', image_url='https://sportshub.cbsistatic.com/i/2021/03/17/e06a80b4-6ed5-4743-8079-300b2c056f12/dragon-ball-z-bulma-1188736.jpg')
    eren = User(
